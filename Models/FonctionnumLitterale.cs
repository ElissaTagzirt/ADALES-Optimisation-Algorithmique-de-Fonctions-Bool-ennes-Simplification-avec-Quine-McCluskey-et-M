...
{
    public class FonctionnumLitterale : TabTermes
    {
        ...
        public List<int> getds()
        {
            ...
            String[] separator = { "," };
            String[] minterm = expression.Split(separator, StringSplitOptions.RemoveEmptyEntries);

            for (int i = 0; i < minterm.Length; i++)
            {

                decimals = Int16.Parse(minterm[i]);
